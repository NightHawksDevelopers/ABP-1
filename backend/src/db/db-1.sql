...
(20, 'Ana Júlia Dias', '672.534.050-48', 'ana.julia@uni.edu.br', 'Mestranda do PPGSR...', 'http://lattes.cnpq.br/3916239078525280', '$2b$10$9YyFqTLmRru/vW67O/DwauhD.gcZ25QoV5FIrF1ReZijsPhw26jbm', '1764075148498-65764159.jpg', FALSE, 5),
...
(15, 'Luiz Gabriel', '213.187.970-98', 'luiz.gabriel@uni.edu.br', 'Doutorando em SR...', 'https://lattes.cnpq.br/9832175220121645', '$2b$10$xhpORrZWZn7TlLSunkNeVe9hlvxHbc.fWxYOKVBZvvHCzybJUC3pu', '1764076342475-24992229.jpg', FALSE, 4),
(13, 'Gabriel Sansigolo', '802.081.210-56', 'gabriel.sansigolo@uni.edu.br', 'Doutorando em CAP...', 'http://lattes.cnpq.br/4094434844735694', '$2b$10$gjxyMuzfZBdlwjcXhX9TFej5zMi7YQVddYpe86sP13Rw/6dKxO45S', '1764076691665-657517487.jpeg', FALSE, 4),
(12, 'Darlan Teles', '305.094.710-13', 'darlan.teles@uni.edu.br', 'Doutorando em SR...', 'http://lattes.cnpq.br/2688151470890069', '$2b$10$RDk31FoX44PGOoKWo8W20OhvtP6oK9DH.5RZAgq0VhYjSWijGRdby', '1764076758628-58468178.jpeg', FALSE, 4),
...
(14, 'Luis Maurano', '158.078.010-59', 'luis.maurano@uni.edu.br', 'Doutorando em SR...', 'http://lattes.cnpq.br/8242319727045776', '$2b$10$KT16iJcPt0s6T7/bsmmNYuNfjtyalCbXY11juFYqOJ7zqGwtPz2F2', NULL, FALSE, 4),
(10, 'Mayrine Silva', '426.266.430-92', 'mayrine.silva@uni.edu.br', 'Bióloga e Eng. Florestal...', 'http://lattes.cnpq.br/7746175904660682', '$2b$10$VeK7czolgZ0lfLqQUR7NgedBCZ8xZMaobH2ccGvb4q0.tw2KSUHEG', '1764076984131-649199128.jpg', FALSE, 3),
...
-- 6. INSERÇÃO DE CONTEÚDO (DIVIDIDO POR TIPO PARA EVITAR ERROS)

-- 6.1 PROJETOS (Tipo 3)
INSERT INTO public.conteudo (
    id_conteudo, co_titulo, co_publicante, co_autor, co_status, co_data_inicio, co_data_termino, co_plano_trabalho, co_lide, co_tipo_conteudo, co_imagem
) VALUES
...
-- 6.2 PUBLICAÇÕES (Tipo 1)
INSERT INTO public.conteudo (
    id_conteudo, co_titulo, co_publicante, co_doi, co_citacao, co_data, co_plano_trabalho, co_tipo_conteudo, co_imagem
) VALUES
...
-- 6.3 VAGAS (Tipo 4)
INSERT INTO public.conteudo (
    id_conteudo, co_titulo, co_publicante, co_data_inicio, co_data_termino, co_requisitos, co_atividades, co_lide, co_status, co_tipo_conteudo
) VALUES 
...
-- 6.4 NOTÍCIAS (Tipo 2)
INSERT INTO public.conteudo (
    id_conteudo, co_titulo, co_publicante, co_data, co_lide, co_conteudo, co_imagem, co_status, co_tipo_conteudo
) VALUES 
(23, 'Equipe do AgriRS conclui validação de campo no Oeste Baiano', 4, '2025-11-20', 'Pesquisadores percorreram mais de 2.000 km...', 'Durante duas semanas, a equipe...', 'campo_oeste_baiano.jpg', 1, 2),
(24, 'Novo satélite CBERS-6 trará avanços para monitoramento de nuvens', 1, '2025-10-15', 'O futuro satélite da parceria Brasil-China...', 'O Instituto Nacional de Pesquisas Espaciais...', 'render_cbers6.jpg', 1, 2),
(25, 'AgriRS Lab apresenta resultados no Simpósio Brasileiro de SR', 19, '2025-04-10', 'Três artigos desenvolvidos pela equipe...', 'O laboratório teve participação massiva...', 'sbsr_apresentacao.jpg', 1, 2);
